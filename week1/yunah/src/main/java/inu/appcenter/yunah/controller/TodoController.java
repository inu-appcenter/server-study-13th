...
import inu.appcenter.yunah.model.todo.response.TodoResponse;
...
public class TodoController {
    ...
    @PatchMapping("/todos/{todoId}")   //Patch : 데이터의 일부만 수정
    public ResponseEntity updateTodo(@PathVariable Long todoId, @RequestBody TodoUpdateRequest todoUpdateRequest) {
